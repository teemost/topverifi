...
<div class="flex flex-col items-center justify-center py-24 text-center">
    ...
    <p class="text-slate-400 max-w-sm">Server 2 hasn't been configured yet. Please contact support.</p>
</div>
@else
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs font-semibold bg-brand/20 text-brand px-2 py-0.5 rounded-full border border-brand/30">Server 2</span>
            </div>
    ...
    <div class="relative w-full max-w-sm bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl p-6 z-10">
        ...
        <div class="flex items-center gap-3 mb-5">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400">via Server 2</p>
            </div>
        </div>
