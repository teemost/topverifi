...
<style>
  ...
  .header .brand { color: #f97316; font-size: 13px; font-weight: 600; margin: 0 0 20px; }
  .header h1 { color: #f1f5f9; font-size: 20px; font-weight: 700; margin: 0; }
...
<div class="wrapper">
  <div class="card">
    ...
    <div class="footer">
      <p>© {{ date('Y') }} {{ $siteName }}. This message was sent directly by our team.</p>
    </div>
  </div>
</div>
</body>
