...
class SettingsController extends Controller
{
    public function index()
    {
        $settings = [
            ...
            'herosms_operator'         => Setting::get('herosms_operator', ''),
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'herosms_operator'        => 'nullable|string|max:50',
        ...
        $keys = [
            ...
            'grizzlysms_api_key', 'herosms_api_key', 'herosms_operator', 'usd_to_ngn_rate', 'whatsapp_number',
